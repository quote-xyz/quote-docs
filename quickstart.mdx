...
<Steps>
  ...
  <Step title="Check your agent wallet">
    ...
    - `builderFeeApproved` is `true`. This is **required**: every Quote-routed order carries Quote's builder code, and Hyperliquid rejects orders from wallets that haven't approved the fee.
